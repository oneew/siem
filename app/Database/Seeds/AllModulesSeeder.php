...
class AllModulesSeeder extends Seeder
{
    ...
    private function seedAlerts()
    {
        ...
        $columns = [
            ...
            'destination_ip', 'description', 'rule_name', 'detection_time', 
            'acknowledged', 'acknowledged_by', 'acknowledged_at', 'resolved_at', 
            'resolution_notes', 'false_positive_reason', 'created_at', 'updated_at'
        ];
    ...
    private function seedRelationships()
    {
        ...
        $this->db->table('incident_assets')->insertBatch($incidentAssets);
    }
}