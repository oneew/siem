...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center">
                    ...
                    <span class="px-2 py-1 rounded text-sm font-medium 
                        ...
                        <?php 
                        $statusIndo = $playbook['status'];
                        if ($statusIndo == 'Active') $statusIndo = 'Aktif';
                        elseif ($statusIndo == 'Inactive') $statusIndo = 'Tidak Aktif';
                        elseif ($statusIndo == 'Draft') $statusIndo = 'Draf';
                        echo esc($statusIndo);
                        ?>
                    </span>
                </div>
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center">
                ...
                <span class="text-gray-900"><?= date('j M Y, H:i', strtotime($playbook['updated_at'])) ?></span>
            </div>
            <?php endif; ?>
    ...
    <div class="border-t border-gray-200 pt-6 mt-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-3">Langkah Eksekusi</h3>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <?php if (!empty($step['estimated_time'])): ?>
                                    <p class="text-sm text-gray-600">Est. waktu: <?= esc($step['estimated_time']) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
...
function confirmDelete(id) {
    if (confirm('Apakah Anda yakin ingin menghapus buku panduan ini? Tindakan ini tidak dapat dibatalkan.')) {
