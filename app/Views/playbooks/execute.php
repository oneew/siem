...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="space-y-3">
            <div class="flex items-center">
                <span class="font-medium text-gray-700 w-32">Estimated Time:</span>
...
<div class="bg-white rounded-lg shadow-md p-6">
    <h3 class="text-lg font-semibold text-gray-800 mb-4">Execution Steps</h3>
                    ...
                    <div class="flex items-start border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="flex-1">
                            ...
                            <?php if (!empty($step['estimated_time'])): ?>
                                <p class="text-sm text-gray-600 mt-1">Est. time: <?= esc($step['estimated_time']) ?></p>
                            <?php endif; ?>
                        </div>
    ...
    <div class="mt-6 flex justify-between items-center">
        <div>
            <label class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600">I confirm that I have reviewed all steps and am ready to execute this playbook</span>
            </label>
        </div>
