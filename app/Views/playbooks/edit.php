        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <select name="type" id="type" required
                    ...
                    <option value="Automated" <?= $playbook['type'] == 'Automated' ? 'selected' : '' ?>>Otomatis</option>
                    <option value="Semi-Automated" <?= $playbook['type'] == 'Semi-Automated' ? 'selected' : '' ?>>Semi-Otomatis</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="severity_level" id="severity_level" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="Low" <?= $playbook['severity_level'] == 'Low' ? 'selected' : '' ?>>Rendah</option>
                    <option value="Medium" <?= $playbook['severity_level'] == 'Medium' ? 'selected' : '' ?>>Sedang</option>
                    <option value="High" <?= $playbook['severity_level'] == 'High' ? 'selected' : '' ?>>Tinggi</option>
                    <option value="Critical" <?= $playbook['severity_level'] == 'Critical' ? 'selected' : '' ?>>Kritis</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="status" id="status" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="Active" <?= $playbook['status'] == 'Active' ? 'selected' : '' ?>>Aktif</option>
                    <option value="Inactive" <?= $playbook['status'] == 'Inactive' ? 'selected' : '' ?>>Tidak Aktif</option>
                    <option value="Draft" <?= $playbook['status'] == 'Draft' ? 'selected' : '' ?>>Draf</option>
                </select>
            </div>
        </div>
