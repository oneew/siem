...
<div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <div class="border-t border-white/20 pt-3 sm:pt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center text-sm gap-2">
                <div class="flex flex-wrap gap-3 sm:gap-6">
                    <span><i class="fas fa-desktop mr-1 sm:mr-2"></i><?= $totalIncidents ?> Incidents</span>
                    <span><i class="fas fa-bell mr-1 sm:mr-2"></i><?= $totalAlerts ?> Alerts</span>
                    <span><i class="fas fa-virus mr-1 sm:mr-2"></i><?= $totalThreats ?> Threats</span>
                </div>
                <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 hover:shadow-xl transition-shadow">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-gray-400"><?= $openIncidents ?> open, <?= $criticalIncidents ?> critical</p>
                </div>
            ...
            <div class="mt-3">
                ...
                <p class="text-xs text-gray-500 mt-1">Open incidents rate</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 hover:shadow-xl transition-shadow">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-xs sm:text-sm text-gray-500">Active Alerts</p>
                    <p class="text-2xl sm:text-3xl font-bold text-gray-800"><?= $activeAlerts ?></p>
                    <p class="text-xs text-gray-400"><?= $criticalAlerts ?> critical</p>
                </div>
            ...
            <div class="mt-3">
                ...
                <p class="text-xs text-gray-500 mt-1">Active alerts rate</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 hover:shadow-xl transition-shadow">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-xs sm:text-sm text-gray-500">Active Threats</p>
                    <p class="text-2xl sm:text-3xl font-bold text-gray-800"><?= $activeThreats ?></p>
                    <p class="text-xs text-gray-400"><?= $highSeverityThreats ?> high severity</p>
                </div>
            ...
            <div class="mt-3">
                ...
                <p class="text-xs text-gray-500 mt-1">Active threats rate</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 hover:shadow-xl transition-shadow">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-green-500 font-semibold">+<?= $resolutionRate ?>% resolution rate</p>
                </div>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-xs sm:text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Alert</th>
                            <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Priority</th>
                            <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <td class="px-3 sm:px-6 py-2 sm:py-4">
                                    <span class="inline-flex px-1.5 py-0.5 sm:px-2 sm:py-1 text-xs font-medium rounded-full
                                        ...
                                        switch($alert['status']) {
                                            ...
                                            case 'Closed': echo 'bg-green-100 text-green-800'; break;
                                            case 'False Positive': echo 'bg-gray-100 text-gray-800'; break;
                                            default: echo 'bg-gray-100 text-gray-800'; break;
                                        }
                                        ?>">
                                        <?= esc($alert['status']) ?>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-xs sm:text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Threat</th>
                            <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Type</th>
                            <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Severity</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="p-3 sm:p-6">
                ...
                <?php else: ?>
                    <div class="text-center py-6 text-gray-500">
                        <i class="fas fa-info-circle text-gray-400 text-xl mb-2"></i>
                        <p>No source IPs recorded yet</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
