    ...
    <div class="bg-white shadow-sm border-b border-gray-200 p-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Tambahkan aset baru ke inventaris pemantauan keamanan Anda</p>
            </div>
            <a href="/assets" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-lg flex items-center shadow-md transition-colors">
    ...
    <div class="flex-1 p-6">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <form action="/assets" method="POST" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="asset_type" 
                                ...
                                <option value="Endpoint">Titik Akhir (Endpoint)</option>
                                <option value="Network Device">Perangkat Jaringan</option>
                                <option value="Mobile">Perangkat Seluler</option>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-blue-800">
                                    <strong>Catatan:</strong> Status kerentanan akan diatur ke "Tidak Diketahui" pada awalnya. 
                                    Jalankan pemindaian keamanan untuk memperbarui penilaian kerentanan.
                                </p>
                            </div>
                        </div>
                    </div>
