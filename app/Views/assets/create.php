    ...
    <div class="bg-white shadow-sm border-b border-gray-200 p-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Add a new asset to your security monitoring inventory</p>
            </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-blue-800">
                                    <strong>Note:</strong> Vulnerability status will be set to "Unknown" initially. 
                                    Run security scans to update the vulnerability assessment.
                                </p>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Adding Asset...';
