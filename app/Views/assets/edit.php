    ...
    <div class="bg-white shadow-sm border-b border-gray-200 p-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Update asset information and security details</p>
            </div>
            <div class="flex space-x-3">
                <a href="/assets/<?= $asset['id'] ?>" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center shadow-md transition-colors">
                ...
                <form action="/asset-management/<?= $asset['id'] ?>" method="POST" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="asset_type" 
                                ...
                                <option value="IoT Device" <?= $asset['asset_type'] == 'IoT Device' ? 'selected' : '' ?>>IoT Device</option>
                        ...
                        <div>
                            <label for="criticality" class="block text-sm font-medium text-gray-700 mb-2">
                                Criticality <span class="text-red-500">*</span>
                            </label>
                        ...
                        <div class="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-yellow-800">
                                    <strong>Note:</strong> Vulnerability status is automatically updated through security scans. 
                                    To update this information, initiate a new security scan for this asset.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <div class="flex justify-between">
                            <button type="button" 
                                    onclick="if(confirm('Are you sure you want to delete this asset?')) { 
                                        window.location.href='/assets/<?= $asset['id'] ?>/delete' 
                                    }"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Updating Asset...';
