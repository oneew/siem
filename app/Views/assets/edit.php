    ...
    <div class="bg-white shadow-sm border-b border-gray-200 p-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Perbarui informasi aset dan detail keamanan</p>
            </div>
            <div class="flex space-x-3">
                <a href="/asset-management/<?= $asset['id'] ?>" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center shadow-md transition-colors">
