...
<head>
  ...
  <title>Login - Platform Keamanan SIEM</title>
  ...
  <div class="login-card w-full max-w-md p-8 rounded-2xl relative z-10">
    ...
    <div class="text-center mb-8">
      ...
      <div class="flex items-center justify-center space-x-4 text-sm text-gray-500">
        ...
        <span><i class="fas fa-eye mr-1"></i>Memantau</span>
        <span><i class="fas fa-chart-line mr-1"></i>Menganalisis</span>
      </div>
    </div>
      ...
      <div class="input-group">
        ...
        <div class="relative">
          <input type="text" name="username"
            ...
            placeholder="Masukkan nama pengguna Anda" required autocomplete="username">
        </div>
      </div>
    ...
    <div class="text-center mt-8 pt-6 border-t border-gray-200">
      ...
      <p class="text-xs text-gray-400 mt-2">
        © 2025 Platform SIEM. Hak cipta dilindungi.
      </p>
    </div>
  </div>
