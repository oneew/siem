                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="attack_type"
                                ...
                                <option value="Web Defacement" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'Web Defacement') ? 'selected' : '' ?>>Web Defacement</option>
                                <option value="Phishing" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'Phishing') ? 'selected' : '' ?>>Phishing</option>
                                <option value="Ransomware" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'Ransomware') ? 'selected' : '' ?>>Ransomware</option>
                                <option value="DDoS" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'DDoS') ? 'selected' : '' ?>>DDoS</option>
                                <option value="Malware" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'Malware') ? 'selected' : '' ?>>Malware</option>
                                <option value="SQL Injection" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'SQL Injection') ? 'selected' : '' ?>>SQL Injection</option>
                                <option value="Brute Force" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'Brute Force') ? 'selected' : '' ?>>Brute Force</option>
                                <option value="Insider Threat" <?= (old('attack_type', $incident['attack_type'] ?? '') == 'Insider Threat') ? 'selected' : '' ?>>Insider Threat</option>
                            </select>
