...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Respons insiden dan manajemen bukti digital</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="card bg-gradient-to-r from-purple-500 to-purple-600 text-white">
            <div class="card-content p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-purple-100 text-sm font-medium">Item Bukti</p>
                ...
                <table class="table w-full">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Penyelidik</th>
                    ...
                    <tbody class="divide-y divide-gray-200" id="casesTableBody">
                        ...
                        <tr class="hover:bg-gray-50" 
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">
                                <?= date('j M Y', strtotime($case['created_at'])) ?>
                            </td>
                            <td class="px-6 py-4 text-sm space-x-2">
                                <a href="/forensics/show/<?= $case['id'] ?>" class="text-blue-600 hover:text-blue-800" title="Lihat Kasus">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="/forensics/add-evidence/<?= $case['id'] ?>" class="text-green-600 hover:text-green-800" title="Tambah Bukti">
...
function exportCases() {
    ...
    setTimeout(() => {
        ...
        showAdvancedToast('success', 'Berhasil', 'Kasus forensik berhasil diekspor');
    }, 2000);
}
</script>
