    ...
    <div class="bg-white shadow-sm border-b border-gray-200 p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">Perbarui informasi intelijen ancaman dan detail IOC</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            <select id="ioc_type"
                                ...
                                <option value="IP" <?= $threat['ioc_type'] == 'IP' ? 'selected' : '' ?>>Alamat IP</option>
                                ...
                                <option value="Email" <?= $threat['ioc_type'] == 'Email' ? 'selected' : '' ?>>Alamat Email</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="threat_type"
                                ...
                                <option value="Suspicious Activity" <?= $threat['threat_type'] == 'Suspicious Activity' ? 'selected' : '' ?>>Aktivitas Mencurigakan</option>
                        ...
                        <div>
                            ...
                            <select id="severity"
                                ...
                                <option value="Low" <?= $threat['severity'] == 'Low' ? 'selected' : '' ?>>Rendah</option>
                                <option value="Medium" <?= $threat['severity'] == 'Medium' ? 'selected' : '' ?>>Sedang</option>
                                <option value="High" <?= $threat['severity'] == 'High' ? 'selected' : '' ?>>Tinggi</option>
                                <option value="Critical" <?= $threat['severity'] == 'Critical' ? 'selected' : '' ?>>Kritis</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="confidence"
                                ...
                                <option value="Low" <?= $threat['confidence'] == 'Low' ? 'selected' : '' ?>>Rendah (Belum Diverifikasi)</option>
                        ...
                        <div>
                            ...
                            <select id="status"
                                ...
                                <option value="Investigating" <?= $threat['status'] == 'Investigating' ? 'selected' : '' ?>>Sedang Diselidiki</option>
                            </select>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description"
                                name="description"
                                rows="3"
                                placeholder="Deskripsi detail mengenai ancaman, konteks, dan informasi tambahan..."
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 text-xs sm:text-sm">
                                <div>
                                    ...
                                    <div class="text-gray-900">
                                        <?= isset($threat['created_at']) ? date('j M Y \p\u\k\u l H:i', strtotime($threat['created_at'])) : 'Tidak diketahui' ?>
                                    </div>
                                </div>
                                <div>
                                    <span class="font-medium text-gray-600">Terakhir Diperbarui:</span>
                                    <div class="text-gray-900">
                                        <?= isset($threat['updated_at']) ? date('j M Y \p\u\k\u l H:i', strtotime($threat['updated_at'])) : 'Tidak diketahui' ?>
                                    </div>
                                </div>
                                <div>
