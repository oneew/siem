...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Memantau dan mengelola Indikator Kompromi (IOCs)</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="card bg-gradient-to-r from-green-500 to-green-600 text-white">
            <div class="card-content p-4 sm:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-green-100 text-sm font-medium">Ancaman Aktif</p>
        ...
        <div class="card bg-gradient-to-r from-red-500 to-red-600 text-white">
            <div class="card-content p-4 sm:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-red-100 text-sm font-medium">Tingkat Tinggi</p>
        ...
        <div class="card bg-gradient-to-r from-yellow-500 to-yellow-600 text-white">
            <div class="card-content p-4 sm:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-yellow-100 text-sm font-medium">Terbaru (24j)</p>
    ...
    <div class="card">
        <div class="card-content p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row gap-3">
                <div class="flex-1">
                    <input type="text" id="searchIOC" placeholder="Cari IOCs..."
                ...
                <table class="table w-full">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jenis</th>
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ancaman</th>
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tingkat Keparahan</th>
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tingkat Kepercayaan</th>
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Terakhir Dilihat</th>
                            <th class="px-2 py-2 sm:px-3 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Aksi</th>
                        </tr>
                    </thead>
                        ...
                        <?php foreach ($threats as $threat): ?>
                            <tr class="hover:bg-gray-50" data-type="<?= $threat['ioc_type'] ?>" data-severity="<?= $threat['severity'] ?>">
                                ...
                                <td class="px-2 py-2 sm:px-3 sm:py-3 text-xs text-gray-900 whitespace-nowrap">
                                    <?= $threat['last_seen'] ? date('j M Y', strtotime($threat['last_seen'])) : 'N/A' ?>
                                </td>
...
<script>
    ...
    function refreshThreatFeed() {
        ...
        setTimeout(() => {
            ...
            showAdvancedToast('success', 'Berhasil', 'Feed intelijen ancaman berhasil disegarkan');
        }, 2000);
    }
</script>
